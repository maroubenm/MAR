...
\subfloat[\label{scolor} hand position using skeleton \\
information in color space ]{\hspace{.5\linewidth}}
\subfloat[\label{sdepth} hand position using skeleton \\
information in depthspace.]{\hspace{.5\linewidth}}
